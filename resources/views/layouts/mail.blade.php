                ...
                <table width="100%">
                    <tr>
                        <td style="padding: 14px; text-align: left;">
                            <img class="lgfoot" src="https://app.latinamericancargo.com/assets/img/lg-white-lac-mlg.png" alt="Logo LAC" style="max-width: 101px; height: auto;">
                        </td>
                        <td>
                            <p class="txtsmd" style="font-size:20px;line-height:1.6;padding: 14px;text-align: right;">Specialization Makes a Difference</p>
                        </td>
                    </tr>
                    <tr>
