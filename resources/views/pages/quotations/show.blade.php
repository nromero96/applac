                            ...
                            {{-- Data the inquiry external 2 --}}
                                ...
                                <div class="col-md-5 mt-0">
                                    ...
                                    <label class="fw-bold mb-0">{{__("Origin")}}:</label> {{ $quotation->origin_country }} 
                                        ...
                                        <label class="fw-bold mb-0">{{__("Destination")}}:</label> {{ $quotation->destination_country }}<br>
                                    <label class="fw-bold mb-0">{{__("Declared value")}}:</label> {{ $quotation->declared_value }} {{ $quotation->currency }}<br>
                                    <label class="fw-bold mb-0">{{__("Shipment readiness")}}:</label> {{ $quotation->shipment_ready_date }}<br>
