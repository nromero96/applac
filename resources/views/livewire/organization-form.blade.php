    ...
    @endif
        <div class="col-md-4">
            <label for="organization_code" class="form-label fw-bold">
                {{__("Code")}} @if (!$showing) <span class="text-danger">*</span> @endif
            </label>
            @if (!$showing)
        ...
        <div class="col-md-4">
            <label for="organization_name" class="form-label fw-bold">
                {{__("Name")}} @if (!$showing) <span class="text-danger">*</span> @endif
            </label>
            @if (!$showing)
        ...
        <div class="col-md-4">
            <label for="organization_address" class="form-label fw-bold">
                {{__("Addresses")}} @if (!$showing) <span class="text-danger">*</span> @endif
            </label>
            @if (!$showing)
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <div class="form-group row mb-1">
                                                <label class="col-sm-4 col-form-label col-form-label-sm pe-0">Job Title: @if (!$showing) <span class="text-danger">*</span>@endif</label>
                                                <div class="col-sm-8">
                                                    @if (!$showing)
