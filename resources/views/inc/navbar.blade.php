<div class="header-container container-xxl">
    <header class="header navbar navbar-expand-sm expand-header">
        ...
        <div class="search-animated toggle-search">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-search d-none"><circle cx="11" cy="11" r="8"></circle><line x1="21" y1="21" x2="16.65" y2="16.65"></line></svg>
            <form class="form-inline search-full form-inline search d-none" role="search">
            ...
            <span class="badge badge-secondary d-none">Ctrl + /</span>

        </div>

        <livewire:agenda-button />
            ...
            {{-- <li class="nav-item dropdown notification-dropdown">
                ...
                <div class="dropdown-menu position-absolute" aria-labelledby="notificationDropdown">
                    <div class="drodpown-title message">
                        <h6 class="d-flex justify-content-between"><span class="align-self-center">{{ __('Notifications') }}</span> <span class="badge badge-secondary">3 New</span></h6>
                    </div>
