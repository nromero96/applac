    ...
    <nav id="sidebar">
            ...
            <div class="nav-logo">
                <div class="nav-item theme-logo">
                    <a href="{{ route('dashboard.index') }}">
                        <img src="{{ asset('assets/img/LAC_Latin-American-Cargo_Logo.png') }}" class="navbar-logo" alt="logo">
                    </a>
                </div>
        ...
        <ul class="list-unstyled menu-categories" id="menudashboardaccordion">
            ...
            <li class="menu {{ ($category_name === 'usefullinks') ? 'active' : '' }}">
                <a href="{{ route('usefullinks.index') }}" aria-expanded="false" class="dropdown-toggle">
                    <div class="">
            ...
            <li class="menu {{ ($page_name === 'settings') ? 'active' : '' }}">
