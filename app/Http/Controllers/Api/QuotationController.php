...
class QuotationController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $validatedData = $request->validate([
            ...
            'origin_label' => 'required|max:255',
            'destination_country_id' => 'required|integer|exists:countries,id',
            'destination_label' => 'required|max:255',
        ...
        $quotation = Quotation::create([
            ...
            'origin_label' => $validatedData['origin_label'],
            'destination_country_id' => $validatedData['destination_country_id'],
            'destination_label' => $validatedData['destination_label'],
