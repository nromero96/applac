...
class DashboardController extends Controller{
    ...
    // public function performance_report_ajax($period = 'all', $date_from = null, $date_to = null){
    public function performance_report_ajax(Request $request){
        $data = $this->performance_report($request->period);
        // echo '<pre>';
        // print_r($request->period);
        // echo '</pre>';
        ?>
        <?php
        return view('components.dashboard-performance', $data);
    }
